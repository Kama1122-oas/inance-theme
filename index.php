...
<body>
 ...
 <div class="hero_area">
 <?php get_header(); ?> <!-- ✅ Moved this to the correct position -->
    ...
    <section class="slider_section ">
      ...
      <div class="container ">
        <div class="row">
          <div class="col-md-6 ">
            <h1>
              <?php echo esc_html(get_theme_mod('home_heading', 'Welcome to Our Website')); ?>
            </h1>
            <p>
              <?php echo esc_html(get_theme_mod('home_paragraph', 'This is a default paragraph. Update it from the settings.')); ?>
            </p>
          <a href="#" class="btn"><?php echo esc_html(get_theme_mod('home_button_text', 'Learn More')); ?></a>
          </div>
          <div class="col-md-6">
    <?php 
    // Get the image from Customizer
    $heading_image = get_theme_mod('home_heading_image'); 
    ?>
    
    <img src="<?php echo esc_url($heading_image); ?>" alt="Heading Image">
</div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-7 col-md-6">
          <div class="img-box">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/images/about-img.jpg" alt="About Image">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/images/professional-img.png" alt="professional Image">
          </div>
        </div>
        <div class="col-md-6 ">
          <div class="detail-box">
